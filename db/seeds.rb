...
cc1= Comment.create(text: "Jon Snow of House Stark, first of his name, King in the North, King Beyond the Wall, Lord of Winterfell, the White Wolf, the Undead", post: pp1 )
cc2= Comment.create(text: "Daenerys Stormborn of the House Targaryen,First of Her Name, the Unburnt, Queen of the Andals and the First Men, Khaleesi of the Great Grass Sea,Breaker of Chains, and Mother of Dragons.", post: pp2)
cc3= Comment.create(text: "I drink and I know things", post: pp3 )
cc4= Comment.create(text: "When you play the game of thrones, you win, or you die", post: pp4 )
cc5= Comment.create(text: "Stick them with the pointy end", post: pp5 )
cc6= Comment.create(text: "I’m a slow learner, it’s true. But I learn", post: pp6)
cc7= Comment.create(text: "The things I do for love.", post: pp7)
cc8= Comment.create(text: "The Spider, the one person with Westero's best interest at heart", post: pp8)
cc9= Comment.create(text: "The first female knight", post: pp9)
cc10= Comment.create(text: "The Three Eyed Raven", post: pp10)
cc11= Comment.create(text: "You know nothin Jon Snow", post: pp1)
cc12= Comment.create(text: "I don't do much of anything anymore", post: pp10)
